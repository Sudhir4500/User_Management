...
const UserList = () => {
   const { itemsPerPage, toggleFavorite, isFavorite } = useContext(PreferencesContext);
    ...
    const fetchUsers = async () => {
      ...
      try {
       const url = query
          ...
          : `https://dummyjson.com/users?limit=${itemsPerPage}&skip=${(page - 1) * itemsPerPage}`;
              ...
              <label tabIndex={0} className="btn btn-outline gap-2">
                ...
                {(genderFilter !== "all" || ageFilter !== "all") && (
                  <span className="badge badge-sm badge-primary">{
                    [genderFilter !== "all" ? 1 : 0, ageFilter !== "all" ? 1 : 0].reduce((a, b) => a + b)
                  }</span>
                )}
              </label>
                ...
                <div className="card-body">
                  ...
                  <div className="form-control mb-4">
                    ...
                    <div className="flex gap-2">
                      <button 
                        className={`btn btn-sm flex-1 ${genderFilter === "all" ? "btn-primary" : "btn-outline"}`}
                        onClick={() => setGenderFilter("all")}
                      >
                        All
                      </button>
                       <button 
                        className={`btn btn-sm flex-1 ${genderFilter === "male" ? "btn-primary" : "btn-outline"}`}
                        onClick={() => setGenderFilter("male")}
                      >
                        Male
                      </button>
                      <button 
                        className={`btn btn-sm flex-1 ${genderFilter === "female" ? "btn-primary" : "btn-outline"}`}
                  ...
                  filteredAndSortedUsers.map((user) => (
                    <tr key={user.id} className="hover">
                     ...
                     <td>
                      ...
                      <td>
                        <div className="dropdown dropdown-end">
                          <label tabIndex={0} className="btn btn-ghost btn-xs font-bold text-xl">...</label>
